...
public class InputMenus {
    ...
    private static class ChoiceInputMenu<T> extends InventoryMenuPage {
        ...
        public ChoiceInputMenu(String title, Type type, Consumer<List<Choice<T>>> callback,
                Choice<T>[] choices) {
            this.title = title;
    ...
    public static <T> InventoryMenuPage picker(String title, Consumer<Choice<T>> callback,
            Choice<T>... choices) {
        return new ChoiceInputMenu<T>(title, Type.PICKER, (chosen) -> {
    ...
    public static <T> InventoryMenuPage toggle(String title, Consumer<List<Choice<T>>> callback,
            Choice<T>... choices) {
        return new ChoiceInputMenu<T>(title, Type.TOGGLE, callback, choices);
    }
