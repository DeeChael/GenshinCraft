...
public class FrogTrait extends Trait {
    ...
    public static void frog(CommandContext args, CommandSender sender, NPC npc, @Flag("variant") Variant variant)
            throws CommandException {
        FrogTrait trait = npc.getOrAddTrait(FrogTrait.class);
        String output = "";
        if (args.hasValueFlag("variant")) {
            if (variant == null) {
                throw new CommandException(Messages.INVALID_FROG_VARIANT, Util.listValuesPretty(Variant.values()));
            }
