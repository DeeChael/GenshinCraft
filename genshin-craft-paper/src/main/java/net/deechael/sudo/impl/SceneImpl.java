...
import net.deechael.sudo.impl.items.ClickerBuilderImpl;
import net.deechael.sudo.impl.items.ImageBuilderImpl;
import net.deechael.sudo.impl.items.SlotBuilderImpl;
import net.deechael.sudo.items.Clicker;
...
public class SceneImpl implements Scene {
    ...
    public SceneImpl(SceneImpl previousScene, PreviousSettings previousSettings, Menu menu, Audience audience) {
        ...
        if (previousScene != null && previousScene.previousSettings.getLines() == this.previousSettings.getLines()) {
            ...
            audience.getPlayer().openInventory(this.bukkit);
        }
    ...
    public @NotNull Renderer refresh(boolean keepLast) {
        RendererImpl renderer = new RendererImpl(this, this.menu, this.audience);
